...
import { createLrcAdapter } from './karaoke-lrc'
export { exportAss } from './karaoke-ass'
export { decodeProject, parseProject, serializeProject } from './project-codec'
export {
  hasValidationErrors,
  MAX_LYRIC_DISPLAY_LINES,
  MAX_PROJECT_DURATION_MS,
...
const { importLrc, exportLrc } = createLrcAdapter({
  maxProjectDurationMs: MAX_PROJECT_DURATION_MS,
  maxProjectLines: MAX_PROJECT_LINES,
  maxProjectWords: MAX_PROJECT_WORDS,
  createLyricWord,
  createLyricLine,
  createVocalTrack,
  createValidationProject: (track) =>
    createProject({ id: createId('lrc-validation-project'), tracks: [track] }),
  validateProject,
})

export { importLrc, exportLrc }
