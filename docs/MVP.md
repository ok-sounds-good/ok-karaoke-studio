...
- [x] A synthetic linked-audio project renders synchronized H.264/AAC MP4 lyric
      ...
      and both 30 and 60 fps; decoded frame evidence proves lyric transitions,
      while a new export defaults to 720p/30. This supporting automated evidence
      does not close the user-held real-song acceptance or distribution gates.
