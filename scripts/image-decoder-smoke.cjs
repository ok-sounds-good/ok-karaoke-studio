...
const { readLinkedImage, validateLinkedImageSnapshot } = require(
  '../electron/linked-image-decoder.cjs',
)
const { createElectronNativeImageDecoder } = require(
  '../electron/native-image-adapter.cjs',
)
